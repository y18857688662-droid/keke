...
app.post('/deploy', (req, res) => {
  ...
  exec('cd /root/keke && git pull origin main && npm install --production 2>/dev/null && bash setup-bridge-relay.sh 2>&1 && bash fix-nginx.sh && systemctl restart keke', { timeout: 60000 }, (err, stdout, stderr) => {
