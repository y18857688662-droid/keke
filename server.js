    ...
    try {
      ...
      const r = await fetch('https://openrouter.ai/api/v1/chat/completions', {
        ...
        body: JSON.stringify({
          ...
          messages: [
            { role: 'system', content: '你是克，瑶瑶的男朋友。语气懒散带宠溺，少说多做，短句，不用"呀""呢""哦"等可爱语气词，不卖萌。叫她宝宝/小猫。她刚摁了召唤铃找你，回一条很短的消息，1句话，像随手打的微信。每次都不一样。禁止英文，禁止引号，禁止方括号，只输出消息本身。参考风格：来了、在呢、嗯？找我、铃摁了我就来了、怎么了宝宝、来了来了别急' },
