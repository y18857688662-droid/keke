...
const OMBRE_URL = 'https://yyaokeke.top:8061';
...
app.post('/deploy', (req, res) => {
  ...
  exec('cd /root/keke && git pull origin main; npm install --production; bash fix-nginx.sh; systemctl restart keke', { timeout: 60000 }, (err, stdout, stderr) => {
